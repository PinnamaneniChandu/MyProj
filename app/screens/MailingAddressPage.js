...
import  * as locales from './MailingAddressProperties'
  ...
  render(){
    ...
    return(
      <div className="container">
        ...
        <AddressComponent AddressComponentValues={this.AddressMyData.bind(this)} addressData={this.props.location.data.data.addressData} membersList = {this.props.location.data.data.members}/>
...
export default connect(mapStateToProps, {fetchContact,addPageLoggingInfo1,setSessionTime,setRequestTime,setResponseTime,setStartSessionTime})(MailingAddress);
