...
import SecondaryHeader from './components/UpdateInfoSecondaryHeader'
...
import  * as locales from './UpdateHouseHoldAddressChangeProperties'
...
class UpdateContactHHAdressChangePage extends React.Component{
...
render(){
    ...
    let redirectTo=this.getRMList().length>0?'Acknowledgement':'UpdateContactInformationPage'
...
export default connect(mapStateToProps, {getHHMembers,fetchMembers,getFormattedDateOfBirth,SelectedPersonList,addPageLoggingInfo1,setSessionTime,setRequestTime,setResponseTime,setStartSessionTime})(UpdateContactHHAdressChangePage)
//export default connect(mapStateToProps, {getHHMembers,fetchMembers,getFormattedDateOfBirth,SelectedPersonList,addPageLoggingInfo})(UpdateContactHHAdressChangePage)
