...
class UpdateHomeAddressValidation extends React.Component{
...
render(){
    ...
    return(
        <div className="container">
			...
			<UpdateAddressValidationComponent displayText="Entered Home Address:" data={this.props.enteredAddress.addressData} members={this.props.enteredAddress.personList} contactType= {this.props.enteredAddress.contactType}/>
			<UpdateAddressValidationComponent displayText="Suggested Home Address:" data={suggestedAddressRender.data} members={this.props.enteredAddress.personList} contactType= {this.props.enteredAddress.contactType} checkValue = {hasValue}/>
			<div style={{marginBottom: 20}}></div>               
			<div className="centerAlignStyle">
				<ButtonFunctionality ButtonName="Edit entered address" redirectTo="UpdateHomeAddress" dstClassName="btn btn-secoundary button-text buttonBack1" data={this.props.enteredAddress}/>
			</div>
        </div>  
        )
    }
...
export default connect(mapStateToProps, {validateAddress, searchValueForName, getInfoInList,getAddressInList,addPageLoggingInfo1,setSessionTime,setRequestTime,setResponseTime,setStartSessionTime})(UpdateHomeAddressValidation)