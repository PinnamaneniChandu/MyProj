...
import  * as locales from '../../screens/components/AddressComponent_Language'
...
class AddressComponent extends React.Component{
  constructor(props){        
    ...
    this.state={ADD2:"",ADD3:"",CITY:"",STATE:"",ZIP:"",USCOUNTY:"", TEMPORARILY: ''}
  }
}
...
if (array.length<=0){
    disabled = false   
    redirectTo = 'ProcessingPage'
} else{
    disabled= true 
    redirectTo = 'AddressComponent'
}
          ...
          <p className="required col-md-12 col-sm-12 col-xs-12">* Indicates a required field</p>
            ...
            <div className="row addIncomeFormDivStyle">
              <div className="col-md-6 col-sm-6 col-xs-6">
                <ButtonFunctionality ButtonName="Cancel" redirectTo="InformationPage" dstClassName="btn button-text buttonBack1"/>
              </div>
...
export default connect(mapStateToProps, {getCTDetails,validateStreet1,validateCity,validateState,validateZipCodeMandatory,validateTEMPORARY,validateZipCode,validatePhoneNumber,validateAreaCode,validateAreaCodeMandatory,validatePhoneNumberMandatory})(AddressComponent)