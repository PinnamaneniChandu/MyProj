...
class UpdateAddressValidationComponent extends React.Component{
    render(){  
        ...
        if(isNotDisabled === 'true' || this.props.data.addressType==='AT1' || this.props.data.addressType==='AT4'){
            ...
            anchorTag = <AnchorFunctionality AnchorText="Use this" redirectTo="UpdateProcessingContactInformation" dstClassName='' data={data} />
...
export default connect(mapStateToProps, {getCTDescription})(UpdateAddressValidationComponent)
