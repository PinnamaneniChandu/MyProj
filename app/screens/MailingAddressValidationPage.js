...
class MailingAddressValidation extends React.Component{
    constructor(props){        
        super(props);
...
render(){
    ...
    return(
        <div className="container">
			...
			<div >
				<AddressValidationComponent displayText="Entered Mailing Address:" data={this.props.enteredAddress.addressData} members={this.props.enteredAddress.personList} contactType= {this.props.enteredAddress.contactType}/>
				<AddressValidationComponent displayText="Suggested Mailing Address:" data={suggestedAddressRender.data} members={this.props.enteredAddress.personList} contactType= {this.props.enteredAddress.contactType} checkValue = {hasValue}/>
				<div style={{marginBottom: 20}}></div>               
				<div className="centerAlignStyle">
					<ButtonFunctionality ButtonName="Edit entered address" redirectTo="MailingAddress" dstClassName="btn buttonBack1" data={this.props.enteredAddress}/>
				</div>
			</div>
        </div>        
        )
...
export default connect(mapStateToProps, {validateAddress, searchValueForName, getInfoInList,getAddressInList,addPageLoggingInfo1,setSessionTime,setRequestTime,setResponseTime,setStartSessionTime})(MailingAddressValidation)