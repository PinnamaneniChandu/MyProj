...
import  * as locales from './UpdateRemoveContactInfoConfirmationProperties'
                ...
                <SecondaryHeader HeadingName={header} homeLink = 'No'/>
                    <div className="annualSummaryDiv sideHeaders" >
                      ...
                      <form ref='RemoveConfirmation_form'>
                          ...
                          <div className="col-md-6 col-sm-6 col-xs-6" style={{textAlign: "center"}}>
                            <ButtonFunctionality ButtonName={lang.ButtonNext} redirectTo="UpdateProcessingContactInformation" dstClassName="btn btn-lg-md btn-lg-sm btn-lg-xs buttonBack1" data={this.state} />
                          </div>
                        </div>
                      </form>    
                    </div>
