...
class UpdateRemoveContactInfoErrorPage extends React.Component{
            ...
            <div className="container">
                ...
                <div className='annualSummaryDiv'>
                        ...
                        <div className="centerAlignStyle" style={{paddingTop: '2px'}}>
                            <ButtonFunctionality ButtonName={lang.ButtonNext} redirectTo="UpdateContactInformationPage" dstClassName="btn btn-lg-md btn-lg-sm btn-lg-xs buttonBack1" />
                        </div>          
                    </div>        
            </div>  
        );
...
export default connect(mapStateToProps, {addPageLoggingInfo1,setSessionTime,setRequestTime,setResponseTime,setStartSessionTime})(UpdateRemoveContactInfoErrorPage)
