...
import  * as locales from './UpdateHomeAddressProperties'
...
class UpdateHomeAddress extends React.Component{
  constructor(props)
  {
    super(props);
  ...
  render(){
    ...
    return(
      <div className="container">
        ...
        <UpdateAddressComponent AddressComponentValues={this.AddressMyData.bind(this)} addressData={this.props.location.data.data.addressData}/>
...
export default connect(mapStateToProps, {fetchContact,addPageLoggingInfo1,setSessionTime,setRequestTime,setResponseTime,setStartSessionTime})(UpdateHomeAddress)
