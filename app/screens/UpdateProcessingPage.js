...
import UpdateHomeAddressValidation from './UpdateHomeAddressValidationPage.js'
import UpdateMailingAddressValidation from  './UpdateMailingAddressValidationPage.js'
...
class UpdateProcessing extends React.Component{
    constructor(props){
        super(props);
    ...
    render(){
        ...
        if(loading) {
            ...
            if(this.props.location.data.data.addressData.addressType === 'AT1') {
                HomeAddressDisplay = <UpdateHomeAddressValidation suggestedAddress={suggestedAddress} enteredAddress={personListAndAddress} userName = {this.props.userName}/>
            }else if(this.props.location.data.data.addressData.addressType === 'AT4') {
                HomeAddressDisplay = <UpdateMailingAddressValidation suggestedAddress={suggestedAddress} enteredAddress={personListAndAddress} userName = {this.props.userName}/>
            }
        }else{
            HomeAddressDisplay = <div><h4>Processing your request....</h4></div>
        }
...
export default connect(mapStateToProps, {validateAddress,addPageLoggingInfo1,setSessionTime,setRequestTime,setResponseTime,setStartSessionTime})(UpdateProcessing)