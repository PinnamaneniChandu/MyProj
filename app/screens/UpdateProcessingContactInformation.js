...
import UpdateContactInformationPage from './UpdateContactInformationPage.js'
import ButtonFunctionality from '../ClickFunc/ButtonFunctionality'
import SecondaryHeader from './components/SecondaryHeader'
import UpdateContactInfoFailurePage from './UpdateContactInformationFailurePage'
...
class UpdateProcessingContactInformation extends React.Component {
    constructor(props){
        super(props);
        ...
        if(operationDetails !== undefined && operationStatus === 'true'){
          if(loading) {
            ...
            informationButtonDisplay =  <div className="container">
                ...
                <ButtonFunctionality ButtonName='Ok' redirectTo="UpdateContactInformationPage" dstClassName="btn button-text buttonBack1  overflow-visible" />
              </div>
            </div>
        }else if(operationStatus === false){
          informationButtonDisplay = <UpdateContactInfoFailurePage/>
        }
        return(
            <div>
...
export default connect(mapStateToProps, { updateAddress, updateEmailAddress, updatePhoneNumber, updatePreferredContact, clearContact,addPageLoggingInfo1,setSessionTime,setRequestTime,setResponseTime,setStartSessionTime})(UpdateProcessingContactInformation)