...
class UpdatePreferredContactInformationPage extends React.Component {
    ...
    onMouseEnterHandler(event) {
        ...
        if (array.length <= 0) {
            ...
            disabled = true
            redirectTo = 'UpdatePreferredContactInformationPage'
        }
                ...
                <div className='annualSummaryDiv'>
                    ...
                    <div className="row form-label-style" >
                        <div className="col-md-6 col-sm-6 col-xs-6">
                            <ButtonFunctionality ButtonName={locales.strings.ButtonCancel} redirectTo="UpdateContactInformationPage" dstClassName="btn button-text buttonBack1" />
                        </div>
                        <div className="col-md-6 col-sm-6 col-xs-6 buttonAlignRight" onMouseEnter={this.onMouseEnterHandler.bind(this)}>
                            <ButtonFunctionality ButtonName={locales.strings.ButtonSave} redirectTo="UpdateProcessingContactInformation" dstClassName="btn button-text buttonBack1" disabled={this.state.disabled} data={preferedContactData}/>
                        </div>
                    </div>
...
export default connect(mapStateToProps, { getHHMembers, getCTDetails, fetchMembers, getFormattedDateOfBirth, SelectedPersonList, addPageLoggingInfo1, setSessionTime, setRequestTime, setResponseTime, setStartSessionTime })(UpdatePreferredContactInformationPage)
