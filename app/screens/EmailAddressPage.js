...
import  * as locales from './EmailAddressProperties'
import $ from 'jquery'
                    ...
                    <div>
                        ...
                        <div className="row addIncomeFormDivStyle">
                            ...
                            <div className="row addIncomeFormDivStyle">
                                    ...
                                    <ButtonFunctionality ButtonName="Save" redirectTo="ProcessingContactInformation" dstClassName="btn buttonBack1 marginLeftForButtons" disabled={this.state.disabled} data={emailData}/>
                                    </div>
                                </div>
                          </div>
                        </form>
...
export default connect(mapStateToProps, {addPageLoggingInfo1,setSessionTime,setRequestTime,setResponseTime,setStartSessionTime})(EmailAddress)