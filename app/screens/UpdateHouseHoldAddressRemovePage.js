...
import  * as locales from './UpdateHouseHoldAddressRemoveProperties'
...
class UpdateHouseHoldAddressRemove extends React.Component{
      ...
      componentWillUnmount(){
		...
		onMouseEnterHandler(event){  
            ...
            if(this.state.stateResident === 'No' && this.state.stateResident !== '' && (this.state.tempAbs === '--Please Select--' || this.state.tempAbs === '') ){
                ...
                let disabled 
                if(array.length<=0){
                    redirectTo =this.state.homeless==="No"?'UpdateRemoveContactInfoErrorPage' :'UpdateRemoveCIConfirmation' 
                    disabled=false
                }
                else{
                    redirectTo ='UpdateContactHHAddressRemove'
                    disabled=true
                }
...
render(){
    ...
    let redirectTo= this.state.homeless==="No"?'UpdateRemoveContactInfoErrorPage' :'UpdateRemoveCIConfirmation'
    ...
    if(this.state.stateResident==="No"){
        ...
        return(
          ...
          <div className="col-md-10 col-sm-10 col-xs-10">
              <ButtonFunctionality ButtonName={lang.ButtonCancel} redirectTo="UpdateContactInformationPage" dstClassName="btn btn-lg-md btn-lg-sm btn-lg-xs buttonBack1"/>            
            </div>
...
export default connect(mapStateToProps, {addPageLoggingInfo1,setSessionTime,setRequestTime,setResponseTime,setStartSessionTime})(UpdateHouseHoldAddressRemove)
